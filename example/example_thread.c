...
void benchmark_example() {
    ...
    BENCH_T(threads, &barrier, 1000, "bench samples tests",
            &benchmark_sample_method, NULL, NULL);
}
...
void benchmark_sampling_example() {
    ...
    threads = 2;
    b_init_barrier(&barrier, threads);
    BENCH_T(threads, &barrier, 1000, "sampling bench samples tests",
            &benchmark_method, NULL, NULL);
}
...
void benchmark_custom_print() {
    ...
    threads = 2;
    b_init_barrier(&barrier, threads);
    BENCH_T(threads, &barrier, 1000, "bench custom print",
            &benchmark_sample_method, custom_print, (void *) msg);
}
